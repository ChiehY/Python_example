...
def testLogin(desc, username, password, result):
   ...
   """
    ...
    checkresult(result)
testUrl = 'https://login.taobao.com/member/login.jhtml?spm=a21bo.50862.201864-2.d1.5dcec6f7PXxn5N&f=top&redirectURL=http%3A%2F%2Fwww.taobao.com%2F'
...
try:
    ...
    testLogin('测试帐户不存在','这是一个不存在的名字','xxxxxxx','该账户名不存在')
